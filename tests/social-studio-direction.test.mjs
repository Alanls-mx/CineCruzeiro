...
test("variações entregam quatro estruturas válidas e dados idênticos", async () => {
  ...
  for (const variationMode of ["similar", "hierarchy"]) {
    ...
    assert.equal(regenerated.evaluatedCount, variationMode === "similar" ? 6 : Object.keys(require('../backend/services/social-studio/contracts/artwork-layout').MOVIE_FAMILIES).length);
