...
function campaignFromRow(row = {}) {
  ...
  return {
    ...
    artDirection: ai.artDirection && typeof ai.artDirection === "object" ? ai.artDirection : {},
    contentSections: Array.isArray(ai.contentSections) ? ai.contentSections : [],
...
function campaignRecord(campaign = {}) {
  const aiMetadata = {
    ...
    artDirection: campaign.artDirection || campaign.aiMetadata?.artDirection || {},
    contentSections: Array.isArray(campaign.contentSections) ? campaign.contentSections.slice(0, 6) : campaign.aiMetadata?.contentSections || [],
