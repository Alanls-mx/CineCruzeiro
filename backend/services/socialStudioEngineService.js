...
function captionForDraft(input = {}, context = {}) {
  ...
  if(draft.content?.releaseScope==='international' || draft.templateId==='movie-price') return require('./social-studio/copy-engine').generateCopy(draft,context).bundle.caption;
