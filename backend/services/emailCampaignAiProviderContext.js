...
function campaignGenerationContext(input = {}, baseline = {}) {
  ...
  return {
    ...
    promptModel: input.promptTemplate ? {
      id: input.promptTemplate.id,
      name: input.promptTemplate.name,
      instructions: String(input.promptTemplate.instructions || input.promptTemplate.prompt || "").slice(0, 12000)
    } : null,
