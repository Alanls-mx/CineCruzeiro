...
const CONCESSION_STYLES = ["cinematic", "impact", "clean", "minimal", "poster-dominant", "hero-left", "hero-right", "split"];
...
const V2_TEMPLATES = Object.freeze([
  ...
  { id: "ticket-offer", name: "Oferta de ingressos", type: "movie", category: "VENDAS", description: "Preço real do ingresso em uma arte tipográfica de impacto.", formats: FORMATS, variants: ["impact", "hero-left", "hero-right", "typography-dominant"], styles: ["impact", "hero-left", "hero-right", "typography-dominant"], fields: ["movie", "offerHeadline", "subtitle", "price", "auxiliaryText", "offerTerms", "cta", "image", "advanced", "caption"], requirements: { movie: true }, render: renderMovieTemplate },
  ...
  { id: "concession-offer", name: "Oferta da bomboniere", type: "concession", category: "BOMBONIERE", description: "Produto real, preço gigante e condições da oferta.", formats: FORMATS, variants: ["impact", "hero-left", "hero-right", "typography-dominant"], styles: ["impact", "hero-left", "hero-right", "typography-dominant"], fields: ["concession", "offerHeadline", "subtitle", "price", "auxiliaryText", "offerTerms", "cta", "image", "advanced", "caption"], requirements: { concession: true }, render: renderConcession },
