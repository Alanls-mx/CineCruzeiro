...
const V2_TEMPLATES = Object.freeze([
  ...
  { id: "online-ticket", name: "Compra online", type: "institutional", category: "VENDAS", description: "Passos simples para comprar ingresso digital.", formats: FORMATS, variants: ["impact", "clean"], styles: ["impact", "clean"], fields: ["title", "subtitle", "auxiliaryText", "cta", "image", "advanced", "caption"], requirements: {}, render: renderOnlineTicket },
  { id: "concession-combo", name: "Produto ou combo", type: "concession", category: "BOMBONIERE", description: "Imagem, composição e preço cadastrados.", formats: FORMATS, variants: ["impact", "clean"], styles: ["impact", "clean"], fields: ["concession", "title", "subtitle", "price", "auxiliaryText", "cta", "image", "advanced", "caption"], requirements: { concession: true }, render: renderConcession },
  { id: "club-plan", name: "Plano do clube", type: "club", category: "CLUBE", description: "Benefícios e mensalidade do plano selecionado.", formats: FORMATS, variants: ["cinematic", "clean"], styles: ["cinematic", "clean"], fields: ["clubPlan", "title", "subtitle", "price", "auxiliaryText", "cta", "image", "advanced", "caption"], requirements: { clubPlan: true }, render: renderClub }
]);
