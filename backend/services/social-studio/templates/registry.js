...
const V2_TEMPLATES = Object.freeze([
  ...
  {id:'multi-movies',name:'Vários filmes',type:'movie',category:'PROGRAMAÇÃO',description:'Programação editorial com até 12 filmes.',formats:FORMATS,variants:MOVIE_STYLES,styles:MOVIE_STYLES,fields:['movies','schedule','title','subtitle','cta','advanced','caption'],requirements:{},render:args=>require('../programming/builders').buildMultiMovieScene(args)}
]);
